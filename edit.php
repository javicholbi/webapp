...
<form role="form" class="col-md-9 go-right" action="update-campo.php" method="post"> <input type="hidden" name="id" value="<?php echo $id;?>">
<!--<form action="update-campo.php" method="post"> <input type="hidden" name="id" value="<?php //echo $id;?>"> -->
<br /> 
Name: 
<br /> 

<input id="name" name="name" type="text" class="form-control" required value="<?php echo @$name = $fila['name'];?>">

<br/><br/> 
Points: 
<br /> 

 <input id="points" name="points" type="text" class="form-control" required value="<?php echo @$points = $fila['points'];?>">
<br/><br/> 
 <?php }  ?>
<!--<input type="submit" value="Editar"> -->
<center>
             <button class="btn btn-primary hidden-print" type="submit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"><span class="oi oi-pencil"></span> Edit</button>
